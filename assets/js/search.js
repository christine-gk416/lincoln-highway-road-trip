function initAutocomplete() {
  ...
  let searchMarkers = []; // Listen for the event fired when the user selects a prediction and retrieve // more details for that place.
  searchBox.addListener("places_changed", () => {
    ...
    searchMarkers = []; // For each place, get the icon, name and location.
